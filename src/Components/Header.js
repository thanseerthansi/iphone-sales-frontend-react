  ...
  <div className="container">
    ...
    <ul className="buy-button  list-none mb-0">
      <li className="inline mb-0">
        <Link to="/">
          <span onClick={()=>setmybagmodal(!mybagmodal)} className="login-btn-primary"><span className="btn btn-icon rounded-full bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white "><BiShoppingBag className="h-5 w-5 " /></span></span>
          <span onClick={()=>setmybagmodal(!mybagmodal)} className="login-btn-light"><span className="btn btn-icon rounded-full bg-gray-50 hover:bg-gray-200 dark:bg-slate-900 dark:hover:bg-gray-700 hover:border-gray-100 dark:border-gray-700 dark:hover:border-gray-700 dark:text-white text-black" ><BiShoppingBag className="h-5 w-5 " /></span></span>
        </Link>
      </li>
      <li className="inline pl-1 mb-0">
       
          <div onClick={()=>setcartmodal(!cartmodal)} className="login-btn-primary"><span className="btn btn-icon cursor-pointer rounded-full bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white"><FiShoppingCart/></span></div>
          <div onClick={()=>setcartmodal(!cartmodal)} className="login-btn-light"><span className="btn btn-icon rounded-full cursor-pointer bg-gray-50 hover:bg-gray-200 dark:bg-slate-900 dark:hover:bg-gray-700 hover:border-gray-100 dark:border-gray-700 dark:hover:border-gray-700  dark:text-white text-black"><FiShoppingCart/></span></div>
      ...
      <div className="lg:col-span-6 md:col-span-6">
        <div className="grid grid-cols-1 gap-[10px]">
          ...
          <div className='grid grid-cols-3 bg-[#f2f2f2] p-5' >
            ...
            <img src="https://www.apple.com/v/iphone-14-pro/c/images/overview/hero/hero_iphone_14_pro__e0act2165xqq_large.jpg" className="rounded-lg w-28" alt={''} />&nbsp;&nbsp;
              </div>
              <div className='col-span-1 '>
            <div>
              <span ><b>iPhone 14</b></span><br/>
            </div>
            <div className='pt-2'>
            ...
            <div className='col-span-1 '>
              ...
              <span ><b>Price :</b> 1230</span>
              </div>
              <div className='flex justify-end'>
              <p className=' h-5 pt-5 hover:text-red-400  text-sm cursor-pointer '><RiDeleteBin6Line size={20}/></p>
              </div>
            </div>
          </div>
          <div className='grid grid-cols-3 bg-[#f2f2f2] p-5' >
            ...
            {/* <div>
              <span className="flex" ><b>Color :</b><div className='rounded-full bg-[#ff0000] w-7 h-7 pl-2'></div> </span><br/>
            </div>
             */}
            <div className='pt-1'>
              <span ><b>Quantity :</b> </span>
            ...
            <div className="lg:col-span-12">
              ...
              <div className="bg-gray-50 dark:bg-slate-800 shadow border border-black md:w-[80%] dark:shadow-gray-800 p-2 rounded-md">
                ...
                <dl className="grid grid-cols-12 mb-0 pb-2">
                  ...
                  <dd className="md:col-span-7 col-span-7 mt-2 text-slate-400">2460 AED</dd>
                  <dt className="md:col-span-5 col-span-5 mt-2">VAT :</dt>
                  <dd className="md:col-span-7 col-span-7 mt-2 text-slate-400">10 AED</dd>
                ...
                <dl className="grid grid-cols-12 mb-0"> 
                  ...
                  <dd className="md:col-span-7 col-span-7 mt-2 text-slate-400">2470 AED</dd>
                </dl>  
              </div>
            </div>
            {/* form start */}
